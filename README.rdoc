...
For example you can send messages to any other numbers like this:
    ...
    ```
You can get more details about the usage of Twilio here: [Twilio Api](https://www.twilio.com/docs)

You can get more information about twilio-ruby gem here: [twilio-ruby](https://github.com/twilio/twilio-ruby)
